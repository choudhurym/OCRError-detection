...
# -*- coding: utf-8 -*-
"""
Created on Thu Dec  3 17:51:18 2020
...
df = pd.read_csv('lexicon_error-word.csv', encoding = "utf-8", header = None)
dfList.append(df)
concatDf = pd.concat(dfList, axis =0)
concatDf.columns=colname
concatDf.to_csv('lexicon_error-word_update.csv', index = None, header=True, encoding = 'utf-8')
...
df1 = pd.read_csv("lexicon_error-word_update.csv", encoding = "utf-8")
df1 = df1.dropna()
...
# # print("\n===================================\nModel Saved\n===================================\n")
# # #dump the model
# # filename = 'lexicon_svm_model.sav'
